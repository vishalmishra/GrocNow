...
public class searchbackground extends AsyncTask<Void,products,Void> {
    Context ctx;
    Activity activity;
    ...
    String pname;
    public searchbackground(Context ctx,String cat){
        this.ctx=ctx;
        this.pname=cat;
        activity=(Activity)ctx;

    }
    String string="http://grocnow.com/android/searchproducts.php";


    @Override
    protected void onPreExecute() {
        recyclerView=(RecyclerView)activity.findViewById(R.id.srecyclerview);
